...
### Added
- Added support for new Angular versions (up to v21).
...
### Fixed
- Fixed disabled property being ignored during initialization with template-driven forms and ngModel. (Issue #65)
